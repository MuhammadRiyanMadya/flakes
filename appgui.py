...
##        self.controller_1.PV.setText(str(self.complex_1.PV))
    ...
    def setModel(self, signal):
        if self.intConst_1.Kp.text() !='' and self.intConst_1.Tp.text() !='':
            d = {"Kp": np.float64(self.intConst_1.Kp.text()), "Tp": np.float64(self.intConst_1.Tp.text())}
            signal.emit(d)
...
##                    print(self.state, end='\n\n')
                    ...
                    self.bufPVoptimizer, self.bufOPoptimizer = mpc.mpcActive(self.bufPVoptimizer, self.bufOPoptimizer,10,5,1,self.PV,self.OP)
...
##                    
                    ...
                    self.OP = mpc.mpcActive(self.bufPVoptimizer, self.bufOPoptimizer,10,5,1,self.PV,self.OP)
